                      ...
                      {isGuest && (
                        <div className="mt-3 p-3 rounded-xl bg-[#F8FAFC] border border-[#E5E7EB] text-xs space-y-2">
                          ...
                          <button
                            ...
                            className="w-full py-2 px-3 rounded-xl bg-[#16A34A] hover:bg-[#15803D] text-white text-xs font-bold transition-all shadow-2xs flex items-center justify-center gap-1.5 cursor-pointer"
                          >
